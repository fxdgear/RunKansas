...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Distance.distance'
        db.alter_column('race_distance', 'distance', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=1))


    def backwards(self, orm):
        
        # Changing field 'Distance.distance'
        db.alter_column('race_distance', 'distance', self.gf('django.db.models.fields.IntegerField')())
