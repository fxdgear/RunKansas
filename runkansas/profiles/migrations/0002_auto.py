...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field races on 'Profile'
        db.create_table('profiles_profile_races', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm['profiles.profile'], null=False)),
            ('race', models.ForeignKey(orm['race.race'], null=False))
        ))
        db.create_unique('profiles_profile_races', ['profile_id', 'race_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field races on 'Profile'
        db.delete_table('profiles_profile_races')
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'races': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['race.Race']", 'null': 'True', 'blank': 'True'}),
